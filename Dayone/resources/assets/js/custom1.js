import {names, checkOptions} from './themeColors';
(function ($) {
	"use strict";
	...
	$('#myonoffswitch55').on('click', function () {
		if (this.checked) {
			...
			(document.getElementById("style")?.setAttribute("href", "http://127.0.0.1:8000/assets/plugins/bootstrap/css/bootstrap.rtl.css"));
