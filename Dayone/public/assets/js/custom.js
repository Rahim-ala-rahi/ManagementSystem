...
if (!document.querySelector('body').firstElementChild.classList.contains('responsive-log') && !document.body.classList.contains('main-content')) {// ***** closed menu *****//
...
if (bodyRtl) {
  ...
  (_document$getElementB = document.getElementById("style")) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.setAttribute("href", "http://127.0.0.1:8000/assets/plugins/bootstrap/css/bootstrap.rtl.css");
}
/***************** RTL HAs Class *********************/
