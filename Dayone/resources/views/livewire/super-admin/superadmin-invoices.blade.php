											...
											<table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="invoice-list">
												...
												<tbody>
													<tr>
														...
														<td>
															<div class="d-flex">
																<a  href="javascript:void(0);" class="action-btns1" data-bs-toggle="tooltip" data-bs-placement="top" title="View"><i class="feather feather-file-text  text-primary"></i></a>
...
@section('scripts')
        ...
        <!-- INTERNAL INDEX JS -->
        <script src="{{asset('assets/js/superadmin/superadmin-invoice.js')}}"></script>
