									...
									<div class="tab-pane fade" id="tab-2" role="tabpanel">
										<div class="card">
											...
											<div class="card-footer">
												<a  href="javascript:void(0);" class="btn btn-success">Save Changes</a>
												<a  href="javascript:void(0);" class="btn btn-danger">Cancel</a>
												<a  href="javascript:void(0);" class="btn btn-info">Send Test Email</a>
											</div>
										</div>
									</div>
...
@section('scripts')
        ...
        <!-- INTERNAL INDEX JS -->
        <script src="{{asset('assets/js/superadmin/superadmin-settings.js')}}"></script>
