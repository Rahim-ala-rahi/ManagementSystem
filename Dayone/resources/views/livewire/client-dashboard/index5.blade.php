										...
										<div class="card">
											<div class="card-header  border-0 responsive-header">
												...
												<div class="card-options">
													<div class="btn-list">
														<a  href="javascript:void(0);" class="btn ripple btn-outline-light text-dark float-start me-4 d-flex  my-sm-0 my-1"><span class="dot-label bg-primary me-2 my-auto"></span>Expenses</a>
														<a  href="javascript:void(0);" class="btn ripple btn-outline-light text-dark float-start me-4 d-flex  my-sm-0 my-1"><span class="dot-label bg-light4 me-2 my-auto"></span>Projects</a>
														<a  href="javascript:void(0);" class="btn ripple btn-outline-light  my-sm-0 my-1" data-bs-toggle="dropdown" aria-expanded="false"> Year <i class="feather feather-chevron-down"></i> </a>
