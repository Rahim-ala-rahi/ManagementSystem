                        ...
                        <div class="page-header d-xl-flex d-block">
							...
							<div class="page-rightheader ms-md-auto">
								<div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
									<div class="btn-list">
										<a href="{{url('hr-addemployee')}}" class="btn btn-primary me-3">Add New Employee</a>
											...
											<table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="hr-table">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																<span class="avatar avatar-md brround me-3" style="background-image: url({{asset('assets/images/users/7.jpg')}})"></span>
																<div class="me-3 mt-0 mt-sm-1 d-block">
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																<span class="avatar avatar-md brround me-3" style="background-image: url({{asset('assets/images/users/8.jpg')}})"></span>
																<div class="me-3 mt-0 mt-sm-1 d-block">
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																<span class="avatar avatar-md brround me-3" style="background-image: url({{asset('assets/images/users/16.jpg')}})"></span>
																<div class="me-3 mt-0 mt-sm-1 d-block">
