                                            ...
                                            <div class="card">
                                                <div class="card-header border-0 responsive-header">
                                                    ...
                                                    <div class="card-options">
                                                        <div class="btn-list">
                                                            <a  href="javascript:void(0);" class="btn  btn-outline-light text-dark float-start d-flex my-1"><span class="dot-label bg-primary me-2 my-auto"></span>Assigned Ticket</a>
                                                            <a  href="javascript:void(0);" class="btn  btn-outline-light text-dark float-start d-flex my-1"><span class="dot-label bg-secondary me-2 my-auto"></span>Closed Ticket</a>
                                                            <a  href="javascript:void(0);" class="btn btn-outline-light my-1" data-bs-toggle="dropdown" aria-expanded="false"> Yearly <i class="feather feather-chevron-down"></i> </a>
...
@section('scripts')
        ...
        <script src="{{asset('assets/js/support/support-agentdash.js')}}"></script>
