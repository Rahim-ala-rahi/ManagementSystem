                                ...
                                <div class="row text-white">
                                    ...
                                    <div class="col col-auto">
                                        <ol class="breadcrumb text-center">
                                            ...
                                            <li class="breadcrumb-item active">
                                                <a  href="javascript:void(0);" class="text-white">Ticket View</a>
                                            </li>
                                        </ol>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-4">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-footer text-center">
                                            <a  href="javascript:void(0);" class="btn btn-light btn-block">Delete Ticket</a>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <div class="card-header  border-0">
                                            ...
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="editsupportnote-icon animated">
                                                        <textarea class="summernote">Lorem ipsum dolor sit amet, quis Neque porro quisquam est, nostrud exercitation ullamco laboris   commodo consequat.</textarea>
