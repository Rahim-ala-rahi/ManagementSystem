...
@section('content')
                        ...
                        <div class="page-header d-lg-flex d-block">
							<div class="page-leftheader">
								<div class="page-title">Typicons</div>
							</div>
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-12 col-sm-12 mb-4">
												<p class="mb-2">Simply beautiful open source icons. For more info <a href="https://iconify.design/icon-sets/typcn/" target="_blank" class="text-primary">click here</a>.</p>
