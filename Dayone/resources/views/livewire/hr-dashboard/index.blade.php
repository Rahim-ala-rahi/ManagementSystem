										...
										<div class="card">
											<div class="card-header border-0 responsive-header">
												...
												<div class="card-options">
													<div class="btn-list">
														<a  href="javascript:void(0);" class="btn  btn-outline-light text-dark float-start d-flex my-sm-0 my-1"><span class="dot-label bg-light4 me-2 my-auto"></span>Employees</a>
														<a  href="javascript:void(0);" class="btn  btn-outline-light text-dark float-start d-flex my-sm-0 my-1"><span class="dot-label bg-primary me-2 my-auto"></span>Budget</a>
								...
								<div class="mb-4">
									...
									<ul class="vertical-scroll">
										<li class="item">
											<div class="card p-4 ">
												<div class="d-flex">
													<img src="{{asset('assets/images/users/16.jpg')}}" alt="img" class="avatar avatar-md bradius me-3">
										...
										<li class="item">
											<div class="card p-4 ">
												<div class="d-flex">
													<img src="{{asset('assets/images/users/4.jpg')}}" alt="img" class="avatar avatar-md bradius me-3">
													<div class="me-3 mt-0 mt-sm-1 d-block">
													...
													<table class="table mb-0 text-nowrap">
														<tbody>
															...
															<tr class="border-bottom">
																<td>
																	<div class="d-flex">
																		<img src="{{asset('assets/images/users/1.jpg')}}" alt="img" class="avatar avatar-md brround me-3">
																		<div class="me-3 mt-0 mt-sm-1 d-block">
															...
															<tr class="border-bottom">
																<td>
																	<div class="d-flex">
																		<img src="{{asset('assets/images/users/4.jpg')}}" alt="img" class="avatar avatar-md brround me-3">
																		<div class="me-3 mt-0 mt-sm-1 d-block">
															...
															<tr class="border-bottom">
																<td>
																	<div class="d-flex">
																		<img src="{{asset('assets/images/users/8.jpg')}}" alt="img" class="avatar avatar-md brround me-3">
																		<div class="me-3 mt-0 mt-sm-1 d-block">
															...
															<tr>
																<td>
																	<div class="d-flex">
																		<img src="{{asset('assets/images/users/9.jpg')}}" alt="img" class="avatar avatar-md brround me-3">
																		<div class="me-3 mt-0 mt-sm-1 d-block">
																			<h6 class="mb-0">Kimberly Berry</h6>
																			<div class="clearfix"></div>
																			<small>Senior Prototyper</small>
