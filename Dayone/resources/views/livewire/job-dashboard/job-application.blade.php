													...
													<tr>
														...
														<td>
															<div class="d-flex">
																...
																<a  href="javascript:void(0);" class="action-btns1" data-bs-toggle="modal" data-bs-target="#jobapplictionmodal">
																...
																<a  href="javascript:void(0);" class="action-btns" data-bs-toggle="tooltip" data-bs-placement="top" title="Download Resume">
...
@section('scripts')
        ...
        <!-- INTERNAL INDEX JS -->
        <script src="{{asset('assets/js/job/job-application.js')}}"></script>
