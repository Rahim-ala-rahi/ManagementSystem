							...
							<div class="col-xxl-3 col-xl-12 col-md-12 col-lg-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="mb-5">
											<div class="d-flex">
												<span class="avatar avatar-lg bradius bg-light me-4" style="background-image: url({{asset('assets/images/files/company/img1.png')}})"></span>
												<div class="mt-1">
										...
										<div class="mb-5">
											<div class="d-flex">
												<span class="avatar avatar-lg bradius bg-light me-4" style="background-image: url({{asset('assets/images/files/company/img2.png')}})"></span>
												<div class="mt-2">
										...
										<div class="mb-5">
											<div class="d-flex">
												<span class="avatar avatar-lg bradius bg-light me-4" style="background-image: url({{asset('assets/images/files/company/img3.png')}})"></span>
												<div class="mt-2">
										...
										<div class="mb-5">
											<div class="d-flex">
												<span class="avatar avatar-lg bradius bg-light me-4" style="background-image: url({{asset('assets/images/files/company/img4.png')}})"></span>
												<div class="mt-2">
										...
										<div class="mb-0">
											<div class="d-flex">
												<span class="avatar avatar-lg bradius bg-light me-4" style="background-image: url({{asset('assets/images/files/company/img5.png')}})"></span>
												<div class="mt-2">
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="mb-5">
											<div class="list-group-item d-flex p-0  align-items-center border-0">
												<div class="d-flex">
													<span class="avatar avatar-lg bradius me-3" style="background-image: url({{asset('assets/images/users/13.jpg')}})"></span>
													<div class="mt-1">
														<h6 class="mb-1 font-weight-semibold fs-16">James Paige
															<span class="font-weight-normal text-muted">Update</span> new Version <span class="font-weight-normal text-muted">angular 10.4....</span>
														</h6>
