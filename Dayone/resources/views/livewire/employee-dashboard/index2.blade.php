                        ...
                        <div class="page-header d-xl-flex d-block">
							...
							<div class="page-rightheader ms-md-auto">
								<div class="d-flex align-items-end flex-wrap my-auto end-content breadcrumb-end">
									<a  href="javascript:void(0);" class="btn btn-primary me-3 mb-md-0 my-1" data-bs-toggle="modal" data-bs-target="#applyleaves">Apply Leaves</a>
									<div class="d-flex me-3 mb-md-0 my-1">
									...
									<div class="d-lg-flex d-block me-3 mb-md-0 my-1">
										<div class="btn-list">
							...
							<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-7">
												<div class="mt-0 text-start"> <h5 class="">Completed Projects</h5>
							...
							<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-7">
												<div class="mt-0 text-start"> <h5 class="">Total Attendance</h5>
							...
							<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-7">
												<div class="mt-0 text-start"> <h5 class="">Absent</h5>
							...
							<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-7">
												<div class="mt-0 text-start"> <h5 class="">Awards</h5>
							...
							<div class="col-xl-5 col-lg-12 col-md-12">
								<div class="card">
									<div class="card-header border-0">
										...
										<div class="card-options me-3">
											<a href="javascript:void(0);" class="btn btn-block btn-primary pe-3 ps-3">Apply For Leave</a>
										</div>
									</div>
								...
								<div class="card">
									<div class="card-header  border-bottom-0">
										...
										<div class="card-options">
											<a href="javascript:void(0);" class="me-0 option-dots text-default" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <span class="feather feather-more-vertical"></span>
											</a>
											<ul class="dropdown-menu dropdown-menu-end" role="menu">
										...
										<table class="table table-vcenter text-nowrap mb-0" id="assigntask">
											...
											<tbody>
												<tr>
													...
													<td class="ps-0">
														<div class="d-flex">
															<div class="table_img brround bg-orange-transparent  me-3">
																<img src="{{asset('assets/images/photos/html.png')}}" alt="img" class="brround">
															</div>
															<div class="my-auto">
													...
													<td class="text-start"><a href="javascript:void(0);" class="btn btn-outline-success btn-block">Completed</a></td>
												...
												<tr>
													...
													<td class="ps-0">
														<div class="d-flex">
															<div class="table_img brround bg-pink-transparent  me-3">
																<img src="{{asset('assets/images/photos/xd.png')}}" alt="img" class="brround">
															</div>
															<div class="my-auto">
													...
													<td class="text-start">
														<div class="avatar-list avatar-list-stacked">
															...
															<img class="avatar avatar-md brround" src="{{asset('assets/images/users/2.jpg')}}" alt="img">
															<img class="avatar avatar-md brround" src="{{asset('assets/images/users/12.jpg')}}" alt="img">
															<img class="avatar avatar-md brround" src="{{asset('assets/images/users/15.jpg')}}" alt="img">
														</div>
													</td>
													<td class="text-start">24 Feb 2020</td>
													<td class="text-start"><a href="javascript:void(0);" class="btn btn-block btn-primary">Accept</a></td>
													<td class="text-start d-flex">
														<a  href="javascript:void(0);" class="action-btns1"><i class="feather feather-mail primary text-primary"></i></a>
														<label class="custom-control custom-checkbox-md">
													...
													<td class="ps-0">
														<div class="d-flex">
															<div class="table_img brround bg-warning-transparent  me-3">
																<img src="{{asset('assets/images/photos/js.png')}}" alt="img" class="brround">
															</div>
															<div class="my-auto">
												...
												<tr>
													...
													<td class="ps-0">
														<div class="d-flex">
															<div class="table_img brround bg-pink-transparent  me-3">
																<img src="{{asset('assets/images/photos/sass.png')}}" alt="img" class="brround">
															</div>
															<div class="my-auto">
													...
													<td class="text-start"><a href="javascript:void(0);" class="btn btn-block btn-outline-success">Completed</a></td>
													<td class="text-start  d-flex">
														<a  href="javascript:void(0);" class="action-btns1"><i class="feather feather-mail primary text-primary"></i></a>
														<label class="custom-control custom-checkbox-md">
												...
												<tr>
													...
													<td class="ps-0">
														<div class="d-flex">
															<div class="table_img brround bg-danger-transparent  me-3">
																<img src="{{asset('assets/images/photos/angular.png')}}" alt="img" class="brround">
															</div>
															<div class="my-auto">
													...
													<td class="text-start">
														<div class="avatar-list avatar-list-stacked">
															...
															<img class="avatar avatar-md brround" src="{{asset('assets/images/users/14.jpg')}}" alt="img">
															<img class="avatar avatar-md brround" src="{{asset('assets/images/users/1.jpg')}}" alt="img">
														</div>
													</td>
										...
										<div class="table-responsive">
											<table class="table text-nowrap mb-0 text-nowrap">
												<tbody>
													<tr>
														<td class="d-flex">
															<img class="w-8 h-8 bradius me-3" src="{{asset('assets/images/users/4.jpg')}}" alt="media1">
															<div class="my-auto">
													...
													<tr>
														<td class="d-flex">
															<img class="w-8 h-8 bradius me-3" src="{{asset('assets/images/users/6.jpg')}}" alt="media1">
															<div class="my-auto">
													...
													<tr>
														<td class="d-flex">
															<img class="w-8 h-8 bradius me-3" src="{{asset('assets/images/users/2.jpg')}}" alt="media1">
															<div class="my-auto">
													...
													<tr>
														<td class="d-flex">
															<img class="w-8 h-8 bradius me-3" src="{{asset('assets/images/users/7.jpg')}}" alt="media1">
															<div class="my-auto">
													...
													<tr>
														<td class="d-flex">
															<img class="w-8 h-8 bradius me-3" src="{{asset('assets/images/users/12.jpg')}}" alt="media1">
															<div class="my-auto">
