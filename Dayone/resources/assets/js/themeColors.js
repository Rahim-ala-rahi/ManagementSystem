import {index, index1, index2, chartbar, balance, advancedtask, spenttask, statistics, employee1, chartstatistics, analysis, expenses, statistics1, overview, chartline1, ticketoverview, chartLine3} from './index';
...
function resetData() {
	...
	responsive();
		...
		(document.getElementById("style")?.setAttribute("href", "http://127.0.0.1:8000/assets/plugins/bootstrap/css/bootstrap.css"));
