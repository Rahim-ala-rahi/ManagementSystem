								...
								<div class="card user-pro-list overflow-hidden">
									<div class="card-body">
										<div class="user-pic text-center">
											<span class="avatar avatar-xxl brround" style="background-image: url({{asset('assets/images/users/1.jpg')}})">
											...
											<div class="pro-user mt-3">
												...
												<div class="rating-stars stars-example-fontawesome block mb-2" id="rating-1" data-stars="2"></div>
												<div class="btn-list">
													<a  href="javascript:void(0);" class="btn btn-light"> <i class="feather feather-edit"></i> </a>
													<a  href="javascript:void(0);" class="btn btn-light"> <i class="feather feather-mail"></i> </a>
												</div>
											</div>
										</div>
									</div>
...
@section('scripts')
        ...
        <!-- INTERNAL INDEX JS -->
        <script src="{{asset('assets/js/task/task-profile.js')}}"></script>
