											...
											<table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="emp-attendance">
												...
												<tbody>
													<tr>
														...
														<td>01-02-2021</td>
														<td>
															<a class="btn btn-primary btn-icon btn-sm" data-bs-toggle="tooltip" data-original-title="View"><i class="feather feather-eye"></i></a>
															...
															<a class="btn btn-info btn-icon btn-sm" data-bs-toggle="tooltip" data-original-title="Print" onclick="javascript:window.print();"><i class="feather feather-printer"></i></a>
															<a class="btn btn-warning btn-icon btn-sm" data-bs-toggle="tooltip" data-original-title="Share"><i class="feather feather-share-2"></i></a>
														</td>
													</tr>
													<tr>
...
@section('scripts')
        ...
        <!-- INTERNAL INDEX JS -->
        <script src="{{asset('assets/js/employee/emp-payslips.js')}}"></script>
